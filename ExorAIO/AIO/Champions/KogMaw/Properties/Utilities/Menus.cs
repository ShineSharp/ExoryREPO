        ...
        public static void Initialize()
        {
            ...
            Variables.SettingsMenu = new Menu("Spells", $"{Variables.MainMenuName}.settingsmenu");
            {
                    ...
                    .SetFontStyle(FontStyle.Regular, Color.Red);
                {
                    ...
                    Variables.RMenu.AddItem(new MenuItem($"{Variables.MainMenuName}.rspell.mana",     "Combo: Mana >= x"))
                        .SetValue(new Slider(60, 1, 99));
                    Variables.RMenu.AddItem(new MenuItem($"{Variables.MainMenuName}.rspell.stacks",   "Combo: Stacks <= x"))
