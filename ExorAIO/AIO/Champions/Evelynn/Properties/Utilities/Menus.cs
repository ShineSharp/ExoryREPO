        ...
        public static void Initialize()
        {
            ...
            Variables.SettingsMenu = new Menu("Spells", $"{Variables.MainMenuName}.settingsmenu");
            {
                    ...
                    .SetFontStyle(FontStyle.Regular, Color.Cyan);
                {
                    ...
                    Variables.EMenu.AddItem(new MenuItem($"{Variables.MainMenuName}.espell.jc",        "JungleClear")).SetValue(true);
                    ...
                    .SetFontStyle(FontStyle.Regular, Color.Red);
                {
                    ...
                    Variables.RMenu.AddItem(new MenuItem($"{Variables.MainMenuName}.rspell.enemies",   "Combo: if hittable Enemies >="))
