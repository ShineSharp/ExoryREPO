namespace ExorKalista
{
    ...
    class Variables
    {
        ...
        /// </summary>
        public static int XOffset { get; set; } = 10;
        public static int YOffset { get; set; } = 20;
        public static int Width { get; set; } = 103;
        ...
        /// <summary>
        /// The jungle target's name.
        /// </summary>
        internal string BaseSkinName = null;
