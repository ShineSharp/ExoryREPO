...
namespace ExorAIO.Champions.Jhin
{
    ...
    class Logics
    {
        ...
        public static void ExecuteR(EventArgs args)
        {
            ...
            /// The R Manager.
            /// </summary>
            Variables.Orbwalker.SetAttack(!Variables.R.Instance.Name.Equals("JhinRShot"));
        ...
        public static void ExecuteAuto(EventArgs args)
        {
            ...
            if (Variables.R.IsReady() &&
                ...
                Variables.Menu.Item($"{Variables.MainMenuName}.rspell.semiauto").IsActive())
            {
                if (Bools.IsInsideRCone(Targets.Target))
                {
